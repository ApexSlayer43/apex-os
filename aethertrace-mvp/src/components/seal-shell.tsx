...
import { SealedFeed } from '@/components/sealed-feed'
  ...
  return (
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 640 }}>
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
            <div style={{ width: 5, height: 5, borderRadius: '50%', background: chainDepth > 0 ? '#10B981' : 'rgba(200,212,228,0.2)' }} />
            <span style={{ fontFamily: 'var(--font-mono)', fontSize: 10, color: 'rgba(200,212,228,0.3)', letterSpacing: '0.06em' }}>
      ...
      {showHistory && items.length > 0 && (
        <div style={{ width: '100%', maxWidth: 640, marginTop: 40, paddingBottom: 80, animation: 'fadeUp 0.3s ease forwards' }}>
