// SOURCE: 21st.dev — Hero ASCII One
// DEPS: UnicornStudio (external CDN script)
// STACK: React + Tailwind + TypeScript
// NOTE: Canvas animation loaded via UnicornStudio external service (not self-hosted)
        ...
        <div className="w-full lg:w-1/2 px-6 lg:px-16 lg:pr-[10%]">
          <div className="max-w-lg relative lg:ml-auto">
            ...
            <div className="flex items-center gap-2 mb-3 opacity-60">
              ...
              <span className="text-white text-[10px] font-mono tracking-wider">&infin;</span>
