      ...
      {markers.map((m) => (
        <div
          ...
          style={{
            ...
            marginBottom: 8, padding: "2px 6px", background: "#1a1a2e", color: "#fff",
      ...
      {arcs.filter((a) => a.label).map((a) => (
        <div
          ...
          style={{
            ...
            bottom: "anchor(top)", left: "anchor(center)", translate: "-50% 0",
            marginBottom: 8, padding: "2px 6px", background: "#fff", color: "#1a1a2e",
            fontFamily: "monospace", fontSize: "0.6rem", letterSpacing: "0.08em",
            textTransform: "uppercase" as const, whiteSpace: "nowrap" as const,
            pointerEvents: "none" as const, boxShadow: "0 1px 4px rgba(0,0,0,0.1)",
        ...
        >
          ...
          <span style={{
            position: "absolute", top: "100%", left: "50%",
            transform: "translate3d(-50%, -1px, 0)",
            border: "5px solid transparent", borderTopColor: "#fff",
          }} />
        </div>
      ))}
    </div>
...
<Globe markers={markers} arcs={arcs} dark={0} mapBrightness={10} />
*/
